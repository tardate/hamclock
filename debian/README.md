...
The current version of HamClock defaults to the old Clear Sky Institute backend server. Since that server is going away or gone, you'll need to point your HamClock to a new server. The blog includes instructions and scripts to help you do that.
